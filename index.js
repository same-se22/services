...
const uri = `mongodb+srv://${process.env.DB}:${process.env.PASS}@cluster0.0th5g.mongodb.net/myFirstDatabase?retryWrites=true&w=majority`;
...
app.get("/", (req, res) => {
  res.send("tourism travel server");
});

app.listen(port, () => {
  console.log("tourism travel server", port);
});